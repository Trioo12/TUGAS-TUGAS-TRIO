...
error_reporting(0);
$obj_kartu = new Kartu();
$data_kartu = $obj_kartu->datakartuu();
...
<form action="kartu_controller.php" method="POST">
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="kode" name="kode" type="text" class="form-control" value="<?= $kar['kode'] ?>">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        <label for="text4" class="col-4 col-form-label">ket</label>
        <div class="col-8">
            <input id="ket" name="ket" type="text" class="form-control" value="<?= $kar['ket'] ?>">
        </div>
    </div>
    <div class="form-group row">
