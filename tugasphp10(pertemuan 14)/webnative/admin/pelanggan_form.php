...
<?php
error_reporting(0);
$obj_pelanggan = new JenisPelanggan();
...
<form action="pelanggan_controller.php" method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="nama_pelanggan" name="nama_pelanggan" type="text" class="form-control"
                value="<?= $pel['nama_pelanggan'] ?>">
        </div>
    </div>
    <div class="form-group row">
        <label for="text3" class="col-4 col-form-label">Alamat</label>
        <div class="col-8">
            <input id="alamat" name="alamat" type="text" class="form-control" value="<?= $pel['alamat'] ?>">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="tgl_lahir" name="tgl_lahir" type="text" class="form-control" value="<?= $pel['tgl_lahir'] ?>">
        </div>
    </div>
    <div class="form-group row">
        <label for="text6" class="col-4 col-form-label">Email</label>
        <div class="col-8">
            <input id="email" name="email" type="text" class="form-control" value="<?= $pel['email'] ?>">
        </div>
    </div>
    <div class="form-group row">
        <label for="text7" class="col-4 col-form-label">Kartu ID</label>
        <div class="col-8">
    ...
    <div class="form-group row">
        <div class="offset-4 col-8">
            ...
            if (empty($idedit)) {
                ...
                ?>
                <button name="proses" type="submit" value="simpan" class="btn btn-primary">Update</button>
