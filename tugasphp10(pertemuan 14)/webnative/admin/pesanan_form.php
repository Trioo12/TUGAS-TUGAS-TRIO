...
<form action="pesanan_controller.php" method="POST">
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="tanggal" name="tanggal" type="text" class="form-control" value="<?= $pes['tanggal'] ?>">
        </div>
    </div>
    <div class="form-group row">
        <label for="text2" class="col-4 col-form-label">Total</label>
        <div class="col-8">
            <input id="total" name="total" type="text" class="form-control" value="<?= $pes['total'] ?>">
        </div>
    </div>
    <div class="form-group row">
